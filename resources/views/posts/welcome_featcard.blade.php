  ...
  <div class="card bg-light mb-3  h-100">
      ...
      <div class="card-footer">
        ...
        <div class="text-right">
          <small class="text-muted">Fest : <a href={{url('fest/'.$text->cat_slug)}}>{{$text->cat_slug}}</a></small>&nbsp&nbsp&nbsp
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <small class="text-muted" data-toggle="tooltip" title="Total Views"><i class="fa fa-eye" style="font-size: 10px;"></i> {{$text->feat}}</small>&nbsp&nbsp&nbsp
        ...
        &nbsp&nbsp&nbsp
          <a href="{{ URL::to('fest/'.$text->cat_slug).'/feat/'.$text->id}}" data-toggle="tooltip" title="Go to Share Wall"><i class="fa fa-arrow-right" aria-hidden="true" style="font-size: 20px;"></i></a></div>
    </div>
  </div>
</div>
@empty
<div class="col-md-4">
<p>No Text wishes yet.</p>
</div>
@endforelse
</div>
...
<div class="col-md-4" style="padding-bottom: 20px"> 
  <div class="card bg-light mb-3  h-100">
      ...
      <div class="card-footer">
        <p class="card-text">
        <div class="text-right">
          <small class="text-muted">Fest : <a href={{url('fest/'.$image->cat_slug)}}>{{$image->cat_slug}}</a></small>&nbsp&nbsp&nbsp
  ...
  <div class="card bg-light mb-3  h-100">
	...
	<img src="{{url('images/wishings/gif/'.$gif->name)}}" alt="Gif not found" class="imagecard">
      ...
      <div class="card-footer">
        <p class="card-text">
        <div class="text-right">
          <small class="text-muted">Fest : <a href={{url('fest/'.$gif->cat_slug)}}>{{$gif->cat_slug}}</a></small>&nbsp&nbsp&nbsp
  ...
  <div class="card bg-light mb-3  h-100">
    ...
    <div class="video-container">
      ...
      <div class="card-footer">
        <p class="card-text">
        <div class="text-right">
          <small class="text-muted">Fest : <a href={{url('fest/'.$video->cat_slug)}}>{{$video->cat_slug}}</a></small>&nbsp&nbsp&nbsp
